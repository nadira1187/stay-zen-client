...
const Banner = () => {
    return (
        <div>
            ...
            >
                <div className="w-1/2 p-0 md:p-5  text-center  text-black  bg-red-200 bg-opacity-50 rounded-xl">
  ...
  <div className="w-full lg:w-1/2 p-4 mr-0 lg:mr-4 lg:p-5 mt-4 md:mt-0 text-white bg-red-200 bg-opacity-75 rounded-xl">
